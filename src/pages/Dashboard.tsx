...
const sections = [
  { title: 'الأوردرات', url: '/orders', icon: Package, color: 'hsl(210,100%,56%)' },
  { title: 'جميع الأوردرات', url: '/unassigned-orders', icon: PackageSearch, color: 'hsl(45,100%,50%)' },
  { title: 'الأوردرات القديمة', url: '/closed-orders', icon: Archive, color: 'hsl(220,15%,55%)' },
  { title: 'بحث شامل', url: '/search', icon: Search, color: 'hsl(200,100%,62%)' },
  { title: 'المكاتب', url: '/offices', icon: Building2, color: 'hsl(152,70%,42%)' },
  { title: 'أسعار التوصيل', url: '/delivery-prices', icon: MapPin, color: 'hsl(45,100%,50%)' },
  { title: 'المنتجات', url: '/products', icon: Box, color: 'hsl(0,85%,55%)' },
  { title: 'العملاء', url: '/customers', icon: Contact, color: 'hsl(200,100%,62%)' },
  { title: 'المندوبين', url: '/couriers', icon: Truck, color: 'hsl(45,100%,50%)' },
  { title: 'المستخدمين', url: '/users', icon: Users, color: 'hsl(200,100%,62%)' },
  { title: 'إدارة الحالات', url: '/status-management', icon: CircleDot, color: 'hsl(270,60%,60%)' },
  { title: 'تحصيلات المندوبين', url: '/courier-collections', icon: Wallet, color: 'hsl(210,100%,56%)' },
  { title: 'حسابات المكاتب', url: '/office-accounts', icon: Building, color: 'hsl(152,70%,42%)' },
  { title: 'السلفات والخصومات', url: '/advances', icon: DollarSign, color: 'hsl(0,85%,55%)' },
  { title: 'التقرير اليومي', url: '/daily-report', icon: Calendar, color: 'hsl(152,70%,42%)' },
  { title: 'التقارير المالية', url: '/financial-reports', icon: BarChart3, color: 'hsl(210,100%,56%)' },
  { title: 'إحصائيات المناديب', url: '/courier-stats', icon: UserCheck, color: 'hsl(45,100%,50%)' },
  { title: 'إحصائيات المكاتب', url: '/office-stats', icon: TrendingUp, color: 'hsl(152,70%,42%)' },
  { title: 'تقرير الأرباح', url: '/profit-report', icon: Calculator, color: 'hsl(0,85%,55%)' },
  { title: 'تتبع الشحنات', url: '/tracking', icon: Locate, color: 'hsl(270,60%,60%)' },
  { title: 'تتبع المناديب', url: '/courier-tracking', icon: Truck, color: 'hsl(152,70%,42%)' },
  { title: 'الطباعة', url: '/print', icon: Printer, color: 'hsl(220,15%,55%)' },
  { title: 'ملاحظات الأوردرات', url: '/order-notes', icon: MessageSquare, color: 'hsl(200,100%,62%)' },
  { title: 'تصدير البيانات', url: '/data-export', icon: FileSpreadsheet, color: 'hsl(152,70%,42%)' },
  { title: 'سجل الحركات', url: '/logs', icon: ScrollText, color: 'hsl(220,15%,55%)' },
  { title: 'الإعدادات', url: '/settings', icon: Settings, color: 'hsl(220,15%,55%)' },
  { title: 'تقرير المكاتب الجديد', url: '/office-report', icon: FileBarChart, color: 'hsl(210,100%,56%)' },
  { title: 'سلة المحذوفات', url: '/trash', icon: Trash2, color: 'hsl(0,85%,55%)' },
